...
use sapling::{
    ...
    Anchor, MerklePath, PaymentAddress, SaplingVerificationContext,
};
...
pub fn validate_transaction_amounts(
    ...
    if fee > 1_000_000_000u64 {
        return Err(SaplingError::InvalidInput(format!(
            "Fee too large: {} zatoshis (max 1 PIV)",
            fee
        )));
    }
...
impl TransactionBuilder {
    ...
    pub fn build_shield_transaction(
        ...
        // Outputs-only bundle; the anchor is irrelevant without spends.
